...
//				isUpdate = findMatchedRecord(accountId, right, leftRecord, isUpdate, intProps.getLeftUniqueColumn(),
//						true);
//			}
//
//			if (isUpdate) {
...
//				isUpdate = findMatchedRecord(accountId, left, rightRecord, isUpdate, intProps.getRightUniqueColumn(),
//						false);
//			}
//
//			if (isUpdate) {
...
//		return isUpdate;
	...
	private Record fillRecord(Record destRecord, Record srcRecord, List<FieldMapEntity> fieldMaps, boolean isLeftToRight) {
